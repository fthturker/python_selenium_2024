...
class TestDefaultSuite():
  ...
  def test_myTest1(self):
    ...
    self.driver.set_window_size(664, 670)
    ...
    self.driver.find_element(By.XPATH, "//input[@id=\'uname\']").click()
    self.driver.find_element(By.ID, "uname").click()
    self.driver.find_element(By.ID, "uname").send_keys("Fatih")
    self.driver.find_element(By.ID, "pwd").send_keys("Turker")
    self.driver.find_element(By.ID, "fname").click()
    self.driver.find_element(By.ID, "fname").send_keys("Fatih")
    self.driver.find_element(By.ID, "lname").send_keys("Turker")
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#owc > option:nth-child(2)").click()
    dropdown = self.driver.find_element(By.ID, "owc")
    dropdown.find_element(By.XPATH, "//option[. = 'Option 1']").click()
    dropdown = self.driver.find_element(By.ID, "owc")
    dropdown.find_element(By.XPATH, "//option[. = 'Option 2']").click()
    ...
    self.driver.find_element(By.ID, "favcolor").send_keys("#d10034")
    self.driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1)").click()
    self.driver.find_element(By.ID, "day").click()
    self.driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1)").click()
    self.driver.find_element(By.ID, "day").click()
    self.driver.find_element(By.ID, "day").send_keys("2023-07-24")
    self.driver.find_element(By.CSS_SELECTOR, "fieldset:nth-child(1)").click()
